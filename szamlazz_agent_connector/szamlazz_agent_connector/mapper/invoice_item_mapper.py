...
class InvoiceItemMapper:
    ...
    def from_sales_invoice_item(sales_invoice_item, tax_rate):
        invoice_item = InvoiceItem(sales_invoice_item.item_name, sales_invoice_item.net_rate, sales_invoice_item.stock_qty, _(sales_invoice_item.stock_uom), str(tax_rate))
